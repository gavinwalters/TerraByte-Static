...
<head>
  ...
  <meta name="description" content='TerraByte - Pioneering the New Digital Landscape. Unleash the potential of "Terra Nova" and embrace limitless possibilities and redefine your online presence.' />
  ...
  <meta property="og:image" content="https://terrabyte.solutions/images/images/darpa_chief_A_close-up_of_a_computer_screen_displaying_a_cuttin_47a1d448-f470-479f-92e8-9fe47ffae133.webp" />
  ...
  <meta name="twitter:image" content="https://terrabyte.solutions/images/images/darpa_chief_A_close-up_of_a_computer_screen_displaying_a_cuttin_47a1d448-f470-479f-92e8-9fe47ffae133.webp" />
  <meta name="twitter:image:alt" content="TerraByte Solutions" />
  <link rel="stylesheet" href="style.css" />
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,300;0,400;1,300;1,400&family=Poppins:wght@100;200;300;400;500;600;700;800;900&family=Roboto:ital,wght@0,400;0,500;0,700;1,400;1,500;1,700&display=swap" rel="stylesheet">
...
<body>
  <header>
    <svg class="logotype" id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1352.1 285.65">
      <defs>
        <style>
          .cls-1 {
            fill: #fff;
  ...
  <section id="contact">
    ...
    <button onclick="window.open('https://wa.me/12898088388');">
      <div class="whatsapp-button">
        <span>
          <svg viewBox="0 0 24 24" fill="currentColor" width="24px" height="24px" data-ux="Icon" class="x-el x-el-svg c1-3k c1-1h c1-3n c1-8y c1-c">
    ...
    <form action="mailer.php" method="post" class="form" enctype="multipart/form-data">
      ...
      <div class="FormField">
        <textarea name="message" id="message" placeholder="Let us hear what's on your mind!" required></textarea>
